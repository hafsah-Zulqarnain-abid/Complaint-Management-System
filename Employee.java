...
public class Employee extends User {
    ...
    public void markAssignmentCompleted(int assignmentId,String dept,String s) {
        ...
        for (Job assignment : assignments) {
            ...
            {
                 //System.out.println(ConsoleInterface.RED_BOLD+"Nothing assigned to you by this Complaint Id");
            }
        }
    ...
    public void viewComplaintDet(int cid)
    {
        ...
        System.out.println("");
        String des=FileManager.getDescriptionByCid(cid, "Complaint.txt");
        System.out.println(ConsoleInterface.WHITE+des);
        System.out.println(ConsoleInterface.ANSI_CYAN+"__________________________________________________________"+ConsoleInterface.ANSI_CYAN);
    }
