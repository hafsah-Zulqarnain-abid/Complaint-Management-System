...
public class Admin extends User {
    ...
    public void addUser() {
        ...
        try {
            ...
            if(newDesignation.equals("manager"))
            {
                 ...
                 if(check == false)
                {
                    ...
                    System.out.println(ConsoleInterface.RED_BOLD+"Department already has a manager");
                     ...
                     FileManager.writeUserToFile(m, "Authen.txt");
                     AllUsers.add(m);
                     System.out.println(ConsoleInterface.ANSI_GREEN+"User added successfully.");
                }
            ...
            if(newDesignation.equals("campusDirector"))
            {
                CampusDirector e=new CampusDirector();
                e.setUsername(newUsername);
                e.setPassword(newPassword);
                e.setDesignation(newDesignation);
                FileManager.writeUserToFile(e, "Authen.txt");
    ...
    public void removeUser() {
        ...
        if (userToRemove != null) {
            ...
            System.out.println(ConsoleInterface.RED_BOLD+"User not found.");
        }
    }
